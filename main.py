...
async def set_commands(bot: Bot):
    commands = [
        ...
        BotCommand(command="/help",
                   description="Brief explanation of the bot's functions 📖"),
        BotCommand(command="/info_sub",
                   description="Information of all subscriptions 📂"),
        BotCommand(command="/add_sub", description="Add a new subscription 📌"),
        BotCommand(command="/remove_sub",
                   description="Remove existing subscription 🗑"),
        BotCommand(command="/statistics",
                   description="Monthly subscription statistics 📊")
    ]
